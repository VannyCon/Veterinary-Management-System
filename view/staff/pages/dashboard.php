                                ...
                                <div class="col-12 col-lg-12 col-md-2">
                                    <div class="card">
                                        <div class="card-body px-3 py-4-5">
                                            ...
                                            <div class="col-md-12">
                                                <h1 class="text-warning ">Welcome staff!</h1>
                                ...
                                <div class="col-6 col-lg-4 col-md-2">
                                    <div class="card">
                                        <div class="card-body px-3 py-4-5">
                                            ...
                                            <p class="card-text">There are <span style="font-size: 1.2em; font-weight: bold; color: yellow;"><?php echo $pendingCount; ?></span> Pending user accounts for approval or decline.</p>
                                            <a href="users.php" class="btn btn-warning">View</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 col-lg-4 col-md-2">
                                    <div class="card">
                                        <div class="card-body px-3 py-4-5">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="card-title">Manage pending appointment</h5>
                                                <p class="card-text">View all Appointments </p>
                                                <a href="transactions.php" class="btn btn-warning">View</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 col-lg-4 col-md-2">
                                    <div class="card">
                                        <div class="card-body px-3 py-4-5">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="card-title">Manage Pet Health Record</h5>
                                                <p class="card-text">View and Update Pet Health Records</p>
                                                <a href="staff.php" class="btn btn-warning">View</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
