        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="appoinment_calendar.php">Calendar</a></li>
                    <li class="nav-item"><a class="nav-link" href="transactions.php">Transaction</a></li>
                    <li class="nav-item"><a class="nav-link" href="approved.php">Approved Transaction</a></li>
    ...
    <script>
        ...
        function renderCalendar(date, slots) {
            ...
            for (let day = 1; day <= lastDate; day++) {
                ...
                link.href = `transactions.php?date=${cellDate}`; // Link to the appointments page
